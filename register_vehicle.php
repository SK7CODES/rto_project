...
$number_plate = $_POST['number_plate']; // Use the generated number plate from the form submission
...
try {
    ...
    header("Refresh: 3; URL=register_user.html"); // Redirect to the user details page after 3 seconds
    exit();
